...
function InfoBlock({
  ...
  return (
    <div className={`mb-8 w-1/2 ${className}`}>
      <div className="uppercase text-xs text-gray-400 font-semibold mb-2 tracking-widest">
        {label}
      </div>
      {children}
    </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-24 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-16 text-gray-900">
        <div className="flex flex-col justify-center">
          ...
          <motion.a
            ...
            className="inline-flex items-center text-2xl md:text-3xl font-mono font-medium text-gray-900 hover:underline focus:underline transition group"
            whileHover={{ x: 8 }}
          >
            {contact.email}
        ...
        <div className="flex flex-col justify-center gap-12 lg:items-end">
          <InfoBlock label={contact.addressLabel}>
            <div className="text-gray-700 leading-relaxed text-base font-mono">
